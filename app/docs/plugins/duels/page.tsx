    ...
    <div style={{ backgroundColor: '#2a0a0a', color: '#fff', minHeight: '100vh', width: '100%', overflowX: 'hidden' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <img src="/images/modes/duels.jpg" alt={t("auto.page.duels")} style={{ width: '40px', height: '40px', borderRadius: '12px' }} />
          <h2 style={{ fontSize: '1.2rem', fontWeight: 600, margin: 0, letterSpacing: '1px', textTransform: 'uppercase' }}>{t("auto.page.duels")}</h2>
        </div>
      ...
      <div style={{ position: 'relative', height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 20px', overflow: 'hidden' }}>
        ...
        >
          {t("auto.page.1v1_2v2_arenas")} <br/>{t("auto.page.settle_the_score")}
                          </motion.p>
      </div>
      ...
      >
        <div style={{ transform: 'skewY(3deg)', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 40px' }}>
          <h2 style={{ fontSize: '4rem', fontWeight: 900, textTransform: 'uppercase', marginBottom: '40px', textAlign: 'center' }}>{t("auto.page.raw_mechanics_zero_excuses")}</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', width: '100%', maxWidth: '1200px' }}>
            <div style={{ background: 'rgba(0,0,0,0.4)', padding: '40px', borderRadius: '20px' }}>
              <h3 style={{ fontSize: '2rem', marginBottom: '20px', color: '#fca5a5' }}>{t("auto.page.custom_arenas")}</h3>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.5 }}>{t("auto.page.hand_crafted_maps_designed_pur")}</p>
            </div>
            <div style={{ background: 'rgba(0,0,0,0.4)', padding: '40px', borderRadius: '20px' }}>
              <h3 style={{ fontSize: '2rem', marginBottom: '20px', color: '#fca5a5' }}>{t("auto.page._challenge")}</h3>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.5 }}>{t("auto.page.pull_anyone_from_the_server_in")}</p>
            </div>
          </div>
        </div>
      </motion.div>
