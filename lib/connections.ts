...
export const PROVIDER_PATHS: Record<ProviderId, string> = {
  steam:
    "M12 2a10 10 0 0 0-9.9 8.7l5.3 2.2a2.8 2.8 0 0 1 1.6-.5h.2l2.4-3.4v-.1a3.8 3.8 0 1 1 3.8 3.8h-.1l-3.4 2.4v.2a2.8 2.8 0 1 1-5.6-.2l-3.8-1.6A10 10 0 1 0 12 2Zm-4 14.9 1.2.5a2.1 2.1 0 1 0 1.6-3.9l-1.3-.5a2.1 2.1 0 0 0-1.5 3.9Zm7.4-4.4a2.5 2.5 0 1 0 0-5.1 2.5 2.5 0 0 0 0 5.1Z",
  faceit: "M22 3.6 13.4 12H22v2H3.2L11 4.4h2.6L7.4 12H10L18.9 2 22 3.6ZM3 20h18v2H3v-2Z",
  discord:
