...
export const PROVIDER_PATHS: Record<ProviderId, string> = {
  ...
  // FACEIT's mark is one wedge, not a letter: the top edge falls from the
  // right corner to the middle, the bottom edge runs back up to it, and the
  // notch on the left is where the two meet. The path it replaced drew a
  // stacked "f" over a rule, which is a shape FACEIT has never used.
  faceit:
    "M23.999 2.705a.167.167 0 0 0-.312-.1 1141.27 1141.27 0 0 0-6.053 9.375H.218c-.221 0-.301.282-.11.352 7.227 2.73 17.667 6.836 23.5 9.134.15.06.39-.08.39-.18z",
  discord:
